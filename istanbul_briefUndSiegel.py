...
Programm zum Brettspiel Istanbul mit Erweiterung "Brief und Siegel"

	Funktionen: 
		- erstellt einen zufälligen Spielplan für das Grundspiel mit der Erweiterung "Brief und Siegel" gemäß Regeln
		...
		- Auswahl eines zufälligen Feldes für Schmuggler, Kurier und Gouverneur
...
def briefUndSiegel():
		...
		# -- SPIELFELDER --
			...
			spielfelder = ["[-     Wagnerei     -]", "[-    Tuchlager     -]", "[-   Gewürzlager    -]", "[-    Obstlager     -]", "[-     Postamt      -]",  
				   ...
				   "[- Edelsteinhändler -]","[-    Botschaft     -]", "[-  Auktionshaus    -]", "[-      Kiosk       -]", "[-    Geheimbund    -]"]
		...
		# -- ENDAUSGABE SPIELFELD --
				...
				print("\n",("\t")*5,"-- Kurier auf           ", spielfelder[random.randint(0,19)],("\n" * 3))                



						
		# -- GOUVERNEUR, Kurier, KAFFEHÄNDLER --
